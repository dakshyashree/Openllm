...
# — Deprecation-safe imports for embeddings & vectorstores
...
def run(file_path: Path, question: str) -> str:
    """
    Given a text file_path and a question string, load its precomputed FAISS index,
    run a RetrievalQA chain, and return the answer.

    Args:
        file_path (Path): Path to the original text file.
